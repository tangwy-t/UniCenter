    ...
    "paths": {
        "/agent/ws": {
            "get": {
                ...
                "responses": {
                    "101": {
                        "description": "握手成功，协议切换到 WebSocket"
                    },
                    "400": {
                        "description": "非 WebSocket 升级请求(缺少 Upgrade 头)"
                    },
                    "403": {
                        "description": "Origin 被 CheckOrigin 拒绝(真跨站请求)"
                    }
                }
            }
        },
        ...
        "/devices": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "主机名(模糊查询)",
                        "name": "hostname",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "启停态(0=停用 1=启用)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "在线状态(true=在线 false=离线)",
                        "name": "online",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.DeviceResp"
                                        }
                                    }
                                }
                            ]
        ...
        "/devices/{id}/metrics": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "资源种类(disk/disk_io/nic/sensor)，与 name 成对",
                        "name": "kind",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "资源名(挂载点/设备名/网卡名/传感器名)，与 kind 成对",
                        "name": "name",
                        "in": "query"
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.DeviceResourceResp"
                                        }
                                    }
                                }
                            ]
                    ...
                    "400": {
                        "description": "参数错误(range 越界 / kind+name 不配对 / 列不在该档可用列集)",
                        "schema": {
                            "$ref": "#/definitions/app.Response"
                        }
                    },
        ...
        "/devices/{id}/resources": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "资源种类(disk/disk_io/nic/sensor)，空表示全部",
                        "name": "kind",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.DeviceResourcesResp"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.KickSessionReq"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "参数错误/不能下线当前会话",
                        "schema": {
                            "$ref": "#/definitions/app.Response"
                        }
                    },
                    "403": {
                        "description": "无权操作该用户会话",
                        "schema": {
                            "$ref": "#/definitions/app.Response"
                        }
                    },
                    "404": {
                        "description": "会话不存在或已下线",
                        "schema": {
                            "$ref": "#/definitions/app.Response"
                        }
                    },
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.SQLStatsSnapshot"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "response.DeviceMetricsResp": {
            ...
            "properties": {
                ...
                "buckets": {
                    "description": "Buckets 稀疏：空桶**不产行**（§7.1），t 有洞；只能用 t 定位，禁止按下标推算。",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.DeviceMetricPoint"
                    }
                },
                "range_seconds": {
                    "description": "RangeSeconds 是实际窗口（秒）。前端按它决定轴刻度与 tooltip 粒度。",
                    "type": "integer"
                },
                "resolution_seconds": {
                    "description": "ResolutionSeconds 是**实际生效**的桶宽（可能因 4000 上限被升档，如 30/900/7200）。\n前端只信本字段，不得按「1h/24h/7d…」按钮名猜粒度。",
                    "type": "integer"
                },
                "source": {
                    "description": "Source 是数据源（redis / db），仅供调试与观测，业务不依赖。",
                    "type": "string"
                }
            }
        },
        "response.DeviceResourceItem": {
            ...
            "properties": {
                ...
                "lastSeenAt": {
                    "description": "LastSeenAt 是最近一次被观测到的时间（unix 秒）；Stale 为 true 时前端应标注「已消失」。",
                    "type": "integer"
                },
                "name": {
                    "type": "string"
        ...
        "response.DeviceResourcePoint": {
            "type": "object",
            "properties": {
                "samples": {
                    "description": "Samples 是命中该资源的样本数（热层档 = 该桶内出现该资源的样本条数；\n子表**没有** samples 列，DB 档恒为 0 —— 完整度信号只在整机宽表上）。",
                    "type": "integer"
                },
                "t": {
                    "type": "integer"
        ...
        "response.DeviceResourceResp": {
            "type": "object",
            "properties": {
                "available_metrics": {
                    "description": "AvailableMetrics 是**这次响应真实的列集**（= 子表的列，或按 metrics 过滤后的子集）。\n它不含 bucket_ts：桶时间走 ` + "`" + `t` + "`" + `，不是 values 里的一个键。",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "buckets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.DeviceResourcePoint"
                    }
                },
                "name": {
                    "description": "挂载点 / 设备名 / 网卡名 / 传感器名",
                    "type": "string"
                },
                "range_seconds": {
                    "type": "integer"
                ...
                "resource_kind": {
                    "description": "disk|disk_io|nic|sensor",
                    "type": "string"
                },
                "source": {
                    "type": "string"
        ...
        "response.DeviceResourcesResp": {
            "type": "object",
            "properties": {
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.DeviceResourceItem"
                    }
                }
            }
        },
        "response.DeviceResp": {
            ...
            "properties": {
                ...
                "cpuUsedPercent": {
                    "description": "以下来自 Redis latest（缺值省略 → 前端显示「—」）",
                    "type": "number"
                },
                "createdAt": {
                    "description": "unix 秒",
        ...
        "response.SQLStatsSnapshot": {
            "type": "object",
            "properties": {
                "by_operation": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/response.SQLDimStats"
                    }
                },
                "by_table": {
                    "type": "object",
                ...
                "global": {
                    "$ref": "#/definitions/response.SQLGlobalStats"
                },
                "slow_queries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.SQLQueryEntry"
                    }
                }
            }
        },
